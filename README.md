...
- [basecall/slow5-dorado.pbs.sh](basecall/slow5-dorado.pbs.sh) - Basecall a S/BLOW5 file using [slow5-dorado](https://github.com/hiruna72/slow5-dorado/releases/). slow5-dorado is a fork of ONT's Dorado that supports S/BLOW5. This script is for slow5-dorado version 1.x.x and supports latest R10.4.1 5KHz data only. For older data (DNA R10.4.1 4kHz, DNA R9.4.1 and RNA002) please use [basecall/slow5-dorado-0.9.6.pbs.sh](basecall/slow5-dorado-0.9.6.pbs.sh).
- [basecall/buttery-eel-dorado.pbs.sh](basecall/buttery-eel-dorado.pbs.sh) - Basecall a S/BLOW5 file using [buttery-eel](https://github.com/Psy-Fer/buttery-eel) wrapper for Dorado. This script is for ont-basecall-server >= 7.11.2 and supports latest R10.4.1 5KHz data only. For older data (DNA R10.4.1 4kHz, DNA R9.4.1, and RNA002), use an [older script](basecall/archived/buttery-eel-0.5.1+dorado7.4.12.pbs.sh). For legacy Guppy basecaller, use [basecall/buttery-eel-guppy.pbs.sh](modcall/buttery-eel-guppy.pbs.sh).
...
- [modcall/slow5-dorado.pbs.sh](modcall/slow5-dorado.pbs.sh) - Modification calling of a S/BLOW5 file using [slow5-dorado](https://github.com/hiruna72/slow5-dorado/releases/). slow5-dorado is a fork of ONT's Dorado that supports S/BLOW5. This script is for slow5-dorado version 1.x.x and supports latest R10.4.1 5KHz data only. For older data (DNA R10.4.1 4kHz, DNA R9.4.1 and RNA002) please use  [modcall/slow5-dorado-0.9.6.pbs.sh](modcall/slow5-dorado-0.9.6.pbs.sh)
...
- [modcall/buttery-eel-dorado.pbs.sh](modcall/buttery-eel-dorado.pbs.sh) - Modification calling of a S/BLOW5 file using [buttery-eel](https://github.com/Psy-Fer/buttery-eel) wrapper for Dorado. This script is for ont-basecall-server >= 7.11.2 and supports latest R10.4.1 5KHz data only. For older data (DNA R10.4.1 4kHz, DNA R9.4.1, and RNA002),  For older data (DNA R10.4.1 4kHz, DNA R9.4.1, and RNA002), use an [older script](modcall/archived/buttery-eel-0.5.1+dorado7.4.12.pbs.sh). For legacy Guppy basecaller, use [modcall/buttery-eel-guppy.pbs.sh](modcall/buttery-eel-guppy.pbs.sh).
